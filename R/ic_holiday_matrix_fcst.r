#' Regression matrix with default holiday regressors for IC, with forecasts
#'
...
#'
#' @format A 1044 x 13 matrix with regressors in each column. The first 10 columns are regular holidays:
#' \describe{
